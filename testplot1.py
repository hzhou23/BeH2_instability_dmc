...
styles = {
'2enoTmoves' :{'label':'2e$^-$ ccECP no T-moves', 'color':'#ff9933', 'linestyle':'--', 'dashes': (3,1), 'marker':'s', 'markersize':6, 'markeredgecolor':'#000000', 'markeredgewidth':0.5},
'2eTmoves'   :{'label':'2e$^-$ ccECP T-moves',    'color':'#009933', 'linestyle':'--', 'dashes': (6,1), 'marker':'o', 'markersize':6, 'markeredgecolor':'#000000', 'markeredgewidth':0.5},
}
...
ccECP_2e_TM = pd.read_csv('2eccECPTmoves.csv')
